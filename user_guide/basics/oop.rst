...
本动画把面向对象的核心概念演给你看：① 类是图纸、对象是产品——从 class 定义到实例化出具体对象的完整过程；② __init__ 构造函数如何初始化属性；③ 继承——父类的属性方法如何「流淌」到子类；④ 装饰器 @property 把方法变只读属性。点击播放，配合下文逐步消化。

.. video:: /_static/videos/T502_Python类与对象代码演示_av1.webm
   :width: 100%
...
.. seealso:: 配套练习：:doc:`/tutorials/basics/ch05_practice`　·　术语参考：:doc:`/api/basics/ch05_terms`　·　示例画廊 :doc:`/gallery/plot_basics/index`