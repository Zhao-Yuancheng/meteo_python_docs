...
.. "gallery\auto_examples\plot_basics\plot_functions.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_auto_examples_plot_basics_plot_functions.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_auto_examples_plot_basics_plot_functions.py:
...
.. image-sg:: /gallery/auto_examples/plot_basics/images/sphx_glr_plot_functions_001.png
   :alt: 兰州站近 7 日气温与热量（函数化处理流程）
   :srcset: /gallery/auto_examples/plot_basics/images/sphx_glr_plot_functions_001.png
...
.. _sphx_glr_download_gallery_auto_examples_plot_basics_plot_functions.py:
