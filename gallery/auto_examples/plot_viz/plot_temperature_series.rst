...
.. "gallery\auto_examples\plot_viz\plot_temperature_series.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_auto_examples_plot_viz_plot_temperature_series.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_auto_examples_plot_viz_plot_temperature_series.py:
...
.. image-sg:: /gallery/auto_examples/plot_viz/images/sphx_glr_plot_temperature_series_001.png
   :alt: 兰州 2024 全年气温综合分析, ① 兰州 2024 逐日平均温：冬冷夏热的年周期, ② 日最高温 vs 日最低温散点（颜色 = 月份）, ③ 全年气温分布直方图（偏态 / 双峰一目了然）
   :srcset: /gallery/auto_examples/plot_viz/images/sphx_glr_plot_temperature_series_001.png
...
.. _sphx_glr_download_gallery_auto_examples_plot_viz_plot_temperature_series.py:
