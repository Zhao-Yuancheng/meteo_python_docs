...
.. only:: html
  ...
  .. image:: /gallery/auto_examples/plot_basics/images/thumb/sphx_glr_plot_functions_thumb.png
    :alt:

  :doc:`/gallery/auto_examples/plot_basics/plot_functions`
...
.. only:: html
  ...
  .. image:: /gallery/auto_examples/plot_basics/images/thumb/sphx_glr_plot_oop_thumb.png
    :alt:

  :doc:`/gallery/auto_examples/plot_basics/plot_oop`
...
.. only:: html
  ...
  .. image:: /gallery/auto_examples/plot_numpy/images/thumb/sphx_glr_plot_pandas_analysis_thumb.png
    :alt:

  :doc:`/gallery/auto_examples/plot_numpy/plot_pandas_analysis`
...
.. only:: html
  ...
  .. image:: /gallery/auto_examples/plot_numpy/images/thumb/sphx_glr_plot_temperature_matrix_thumb.png
    :alt:

  :doc:`/gallery/auto_examples/plot_numpy/plot_temperature_matrix`
...
.. raw:: html
    ...
    <div class="sphx-glr-thumbcontainer" tooltip="本章目标：用 Xarray 读取 NetCDF 再分析气温场，对其进行时间切片、 空间子区域裁剪，并做纬度加权区域平均，最后画出「某时刻空间气温场 + 区域平均时间序列」两张图，贯穿项目第 8 步。">

.. only:: html

  .. image:: /gallery/auto_examples/plot_numpy/images/thumb/sphx_glr_plot_xarray_field_thumb.png
    :alt:

  :doc:`/gallery/auto_examples/plot_numpy/plot_xarray_field`
...
.. only:: html
  ...
  .. image:: /gallery/auto_examples/plot_viz/images/thumb/sphx_glr_plot_cartopy_temp_thumb.png
    :alt:

  :doc:`/gallery/auto_examples/plot_viz/plot_cartopy_temp`
...
.. raw:: html
    ...
    <div class="sphx-glr-thumbcontainer" tooltip="本脚本演示如何用 Matplotlib 的面向对象接口，把一套整年的逐日气温数据 绘制成一张 3 行子图的综合图板：上图为逐日平均温的年周期曲线（叠加月均温 并标注冬夏极值点），中图为日最高温与日最低温的相关性散点，下图为全年气温 分布直方图。">

.. only:: html

  .. image:: /gallery/auto_examples/plot_viz/images/thumb/sphx_glr_plot_temperature_series_thumb.png
    :alt:

  :doc:`/gallery/auto_examples/plot_viz/plot_temperature_series`
