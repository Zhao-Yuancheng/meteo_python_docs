...
.. "gallery\auto_examples\plot_numpy\plot_xarray_field.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_auto_examples_plot_numpy_plot_xarray_field.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_auto_examples_plot_numpy_plot_xarray_field.py:
...
.. image-sg:: /gallery/auto_examples/plot_numpy/images/sphx_glr_plot_xarray_field_001.png
   :alt: Xarray 西北气温场分析示例, 某时刻河西走廊气温场, 区域平均气温时间序列
   :srcset: /gallery/auto_examples/plot_numpy/images/sphx_glr_plot_xarray_field_001.png
...
.. _sphx_glr_download_gallery_auto_examples_plot_numpy_plot_xarray_field.py:
