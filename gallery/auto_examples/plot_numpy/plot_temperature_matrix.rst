...
.. "gallery\auto_examples\plot_numpy\plot_temperature_matrix.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_auto_examples_plot_numpy_plot_temperature_matrix.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_auto_examples_plot_numpy_plot_temperature_matrix.py:
...
.. image-sg:: /gallery/auto_examples/plot_numpy/images/sphx_glr_plot_temperature_matrix_001.png
   :alt: 多站气温矩阵：原始数据 vs 逐站标准化, 西北 5 站 7 天最高气温（℃）, 逐站 Z-score 标准化
   :srcset: /gallery/auto_examples/plot_numpy/images/sphx_glr_plot_temperature_matrix_001.png
...
.. _sphx_glr_download_gallery_auto_examples_plot_numpy_plot_temperature_matrix.py:
