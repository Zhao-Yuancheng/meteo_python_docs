...
.. "gallery\plot_sci\plot_ekma_curve.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`转到文末 <sphx_glr_download_gallery_plot_sci_plot_ekma_curve.py>`
        下载完整的示例代码.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_plot_sci_plot_ekma_curve.py:
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    数据来源： 配套数据 ../../data/clean_data.xlsx
    表规模 (行, 列): (121, 3)
     NOx ppb  VOCs ppb  O3 ppb
           0         0    0.00
          24         0   20.65
          48         0   18.32
          72         0   17.58
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    网格形状 (VOCs 行数, NOx 列数): (11, 11)
    O₃ 浓度范围 (ppb): 0.0 ~ 173.3
...
.. image-sg:: /gallery/plot_sci/images/sphx_glr_plot_ekma_curve_001.png
   :alt: EKMA 曲线：O$_3$ 浓度对 NOx 与 VOCs 的响应
   :srcset: /gallery/plot_sci/images/sphx_glr_plot_ekma_curve_001.png
...
.. _sphx_glr_download_gallery_plot_sci_plot_ekma_curve.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`下载 Jupyter Notebook：plot_ekma_curve.ipynb <plot_ekma_curve.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`下载Python源码：plot_ekma_curve.py <plot_ekma_curve.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`下载压缩包：plot_ekma_curve.zip <plot_ekma_curve.zip>`
