...
.. code:: text
   ...
   OSError: [Errno -51] NetCDF: Unknown file format: 'data\\bogus.nc'
...
**现象 / 真实输出**\ ：用绝对 K 温度（~12K）对一个注定全 False 的条件 ``> 100`` 做 where\ ，结果整场被置 NaN，比例 1.0：
...
.. code:: text
   ...
   PermissionError: [Errno 13] Permission denied: 'no\\such\\dir\\out.nc'
