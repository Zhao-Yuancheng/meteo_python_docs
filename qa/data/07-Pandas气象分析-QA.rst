...
==================================
   ...
   **章节定位**\ ：第 7 章（模块二）· 对应用户指南
   ...
   :doc:`00-通用排错指南 </qa/00-通用排错指南>`\ （0.1 节「报错 / 警告 /
...
.. code:: python
   ...
   import pandas as pd
   pd.read_csv("D:/气象实验数据/not_exist_123.csv")

.. code:: text

   Traceback (most recent call last):
     ...
   FileNotFoundError: [Errno 2] No such file or directory: 'D:/气象实验数据/not_exist_123.csv'
...
.. code:: python
   ...
   import pandas as pd
   path = "D:/气象实验数据/weather_stations.csv"
