...
.. seealso:: 配套正文：:doc:`/user_guide/basics/python_conda`　·　术语参考：:doc:`/api/basics/ch01_terms`
...
.. dropdown:: 参考答案
   ...
   B。create 是创建环境，-n 指定环境名，python=3.10 指定版本。
...
.. dropdown:: 参考答案
   ...
   C。激活环境用 conda activate；退出用 conda deactivate。
...
.. dropdown:: 参考答案
   ...
   .. warning::
      ...
      直接运行脚本前务必先激活目标环境，否则可能装错环境或找不到库。
...
.. dropdown:: 参考答案
   ...
   .. note::
      ...
      f"{...}" 是 f-string，{} 里放变量，.2f 可控制小数位数（第 2 章详述）。
